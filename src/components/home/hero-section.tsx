  ...
  return (
    <section className="relative w-full h-[65vh] sm:h-[75vh] min-h-[400px] overflow-hidden bg-black flex flex-col items-center justify-end pb-12 sm:pb-16">
      ...
      <button
        ...
        className="absolute left-3 sm:left-5 top-1/2 -translate-y-1/2 z-20 w-10 h-10 sm:w-12 sm:h-12 rounded-full bg-white/10 backdrop-blur-sm border border-white/30 text-white flex items-center justify-center hover:bg-white hover:text-luxury-black transition-colors duration-300"
      >
      ...
      <button
        ...
        className="absolute right-3 sm:right-5 top-1/2 -translate-y-1/2 z-20 w-10 h-10 sm:w-12 sm:h-12 rounded-full bg-white/10 backdrop-blur-sm border border-white/30 text-white flex items-center justify-center hover:bg-white hover:text-luxury-black transition-colors duration-300"
      >
        <svg className="h-5 w-5 sm:h-6 sm:w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
